...
void exe_DE_current_best(vector <Instance> & train, vector <Instance> & test, float & tasa, float & time1, float & t_train, float & red1, float & agr1){
	//Variables auxilaires
	unsigned t0, t1;
	float elapsed_time;
...
void exe_DE_best(vector <Instance> & train, vector <Instance> & test, float & tasa, float & time1, float & t_train, float & red1, float & agr1){
	//Variables auxilaires
	unsigned t0, t1;
	float elapsed_time;
